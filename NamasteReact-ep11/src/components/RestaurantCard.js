...
// Higher Order Component takes RestaurantCard as an argument and returns an Enhanced RestaurantCard.
//input - RestaurantCard ; output - VegRestaurantCard

export const withVegLabel = (RestaurantCard) => {
  return (props) => {
    return (
      <div className="relative">
        <div className="absolute left-2 rounded-lg p-2 bg-slate-500 text-white">
          VEG ONLY
        </div>
